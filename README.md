# A simple Batch Renamer for Blender

A lightweight, aesthetically minimalistic batch renaming tool designed for Blender 4.5.5 LTS.

## Features
- **Clean UI**: Integrates seamlessly into the 3D Viewport sidebar (N-Panel) under the "Renamer" tab.
...
4. Check the box next to "Object: Sleek Batch Renamer" to enable it.
